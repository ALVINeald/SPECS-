<?php//USUAL CONNECTION TO THE DATABASE
session_start();
...
// ── STORE COORDINATES (Mbarara City) AS PER GOOGLE──────────────────────────
$storeCoords = [
...
// ── GET ALL PRICES FOR BASKET ITEMS, ITEMS SELECTED ───────────────────────────
...
// Group all prices by product s per the user selection
$allPricesMap = [];
...
// What would it cost to buy EVERYTHING at the single cheapest store? #the idea!
$singleStoreTotals = [];
...
// Building Google Maps URL with all stops
$gmapsUrl = '';
