    ...
    <div class="product-card">
      ...
      <div class="pc-price-row">
        <div>
          ...
          <div class="pc-best-price" data-product-id="<?= $p['id'] ?>"><?= formatPrice($minPrice) ?></div>
          <?php if ($p['max_price'] > $minPrice): ?>
          <div class="pc-worst-price" data-product-id="<?= $p['id'] ?>"><?= formatPrice($p['max_price']) ?></div>
          <?php endif; ?>
        </div>
        <?php if ($savings > 1000): ?>
...
<script src="../assets/js/live-prices.js"></script>
